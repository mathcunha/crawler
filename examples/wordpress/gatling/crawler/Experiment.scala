...
class SimplePost extends Experiment {


        val httpConf = httpConfig
                        .baseURL("http://54.198.116.121/")
                        .acceptHeader("*/*")
        ...
        val scn = scenario("Scenario Name")
                .repeat(10){
                        ...
                        .exec(http("find posts")
                                .post("/xmlrpc.php")
                                .body("<?xml version='1.0'?> <methodCall> <methodName>blogger.getRecentPosts</methodName> <params> <param> <value>not empty</value> </param> <param> <value>not empty</value> </param> <param> <value>crawler-admin</value> </param> <param> <value>crawler-admin</value> </param>  <param> <value>50</value> </param> </params> </methodCall>")
        ...
        setUp(scn.users(50).protocolConfig(httpConf))
}